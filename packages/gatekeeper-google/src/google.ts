...
import { GatekeeperUser, GatekeeperUserVerifier, GatekeeperVendor as GatekeeperVendorIface, Gatekeeper, ResourceDescription, ApprovalQueue, ObservationDescription, VendorDescription, VendorSetup, VendorSetupInput, GatekeeperConnectCallback, GatekeeperConnectOptions, AccountDescription, SupportedResource, ResourceConfiguratorFrame, Cursor, ActionKind, stripTrailingSlashes } from '@gadgets/workshop-shared/gatekeeper';
...
type Env = Cloudflare.Env & {
  ...
  BASE_URL?: string;
  // Deploy-time OAuth app fallback (wrangler secrets / .dev.vars); not in wrangler.jsonc. Tenant
